import { DropdownContext, useDropdownState } from "@simplix/headless";
...
export function DropdownRoot(props: DropdownRootProps): JSX.Element {
    const { children, className, style, open = false, onChangeState, disabled = false } = props;
    ...
    return (
        <DropdownContext.Provider value={value}>
            <div ref={dropdownRef} className={className ?? "dropdown"} style={style}>
                {children}
            </div>
